...
#if (DPCT_COMPATIBILITY_TEMP >= 500)
                static __dpct_inline__ uint32_t LOP3LUT_XOR(uint32_t a,
                                                            uint32_t b,
                                                            uint32_t c) {
                        uint32_t d;
    d = a ^ b ^ c;
                ...
                static __dpct_inline__ uint32_t LOP3LUT_XORAND(uint32_t a,
                                                               uint32_t b,
                                                               uint32_t c) {
                        uint32_t d;
    d = (a ^ (b & (c ^ a)));
                ...
                static __dpct_inline__ uint32_t LOP3LUT_ANDOR(uint32_t a,
                                                              uint32_t b,
                                                              uint32_t c) {
                        uint32_t d;
    d = ((a & (b | c)) | (b & c));
