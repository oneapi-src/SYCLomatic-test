...
def migrate_test(single_case_text):
    ...
    call_subprocess(single_case_text.CT_TOOL + " -in-root=helloworld_tst/src/rootdir helloworld_tst/src/rootdir/../test.cu --cuda-include-path=" + single_case_text.include_path, single_case_text)
