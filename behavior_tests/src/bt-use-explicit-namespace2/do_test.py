...
def migrate_test(single_case_text):
    ret = call_subprocess(single_case_text.CT_TOOL + " --use-explicit-namespace=dpct --out-root=./sycl vector_add.cu --cuda-include-path=" + single_case_text.include_path, single_case_text)
    return ret
