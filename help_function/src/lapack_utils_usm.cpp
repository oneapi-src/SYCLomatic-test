...
void test_cusolverDnTgesvdj() {
  ...
  */
  ...
  void* device_ws_z;
  device_ws_s =
      (void *)sycl::malloc_device(device_ws_size_s * sizeof(float), q_ct1);
  device_ws_d =
      (void *)sycl::malloc_device(device_ws_size_d * sizeof(double), q_ct1);
  device_ws_c = (void *)sycl::malloc_device(
      device_ws_size_c * sizeof(sycl::float2), q_ct1);
  device_ws_z = (void *)sycl::malloc_device(
      device_ws_size_z * sizeof(sycl::double2), q_ct1);
...
void test_cusolverDnSyevdx() {
  ...
  */
  ...
  void* device_ws_c;
  void* device_ws_z;
  device_ws_s = (void *)sycl::malloc_device(lwork_s, q_ct1);
  device_ws_d = (void *)sycl::malloc_device(lwork_d, q_ct1);
  device_ws_c = (void *)sycl::malloc_device(lwork_c, q_ct1);
  device_ws_z = (void *)sycl::malloc_device(lwork_z, q_ct1);
...
void test_cusolverDnTsyevdx_cusolverDnTheevdx() {
  ...
  */
  ...
  device_ws_s = sycl::malloc_device<float>(lwork_s, q_ct1);
  device_ws_d = sycl::malloc_device<double>(lwork_d, q_ct1);
  device_ws_c = sycl::malloc_device<sycl::float2>(lwork_c, q_ct1);
  device_ws_z = sycl::malloc_device<sycl::double2>(lwork_z, q_ct1);
...
void test_cusolverDnTsyheevd() {
  ...
  work_s = sycl::malloc_device<float>(lwork_s, q_ct1);
  work_d = sycl::malloc_device<double>(lwork_d, q_ct1);
  work_c = sycl::malloc_device<sycl::float2>(lwork_c, q_ct1);
  work_z = sycl::malloc_device<sycl::double2>(lwork_z, q_ct1);
  devInfo = sycl::malloc_device<int>(1, q_ct1);
  ...
  sycl::free(work_s, q_ct1);
  sycl::free(work_d, q_ct1);
  sycl::free(work_c, q_ct1);
  sycl::free(work_z, q_ct1);
  sycl::free(devInfo, q_ct1);
