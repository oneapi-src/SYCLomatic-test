// ====------ onedpl_test_stable_partition_copy.cpp---------- -*- C++ -* ----===////
//
...
class StablePartitionCopy1 {};     // name for policy
class StablePartitionCopy2 {};     // name for policy
...
int main() {
...

    {
        ...
        auto new_policy = oneapi::dpl::execution::make_device_policy<StablePartitionCopy1>(oneapi::dpl::execution::dpcpp_default);
...

    {
        ...
        // create named policy from existing one
        auto new_policy = oneapi::dpl::execution::make_device_policy<StablePartitionCopy2>(oneapi::dpl::execution::dpcpp_default);

        // call algorithm:
        dpct::stable_partition_copy(new_policy, inp_it, inp_end_it, stn_it, out_true_it, out_false_it,
                                               oneapi::dpl::identity());
