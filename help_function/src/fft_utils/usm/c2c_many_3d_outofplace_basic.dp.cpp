// ===--- c2c_many_3d_outofplace_basic.dp.cpp -----------------*- C++ -*---===//
//
...
bool c2c_many_3d_outofplace_basic() {
  ...
  forward_idata_d = sycl::malloc_device<sycl::float2>(48, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::float2>(48, q_ct1);
  backward_odata_d = sycl::malloc_device<sycl::float2>(48, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::float2) * 48)
      .wait();
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::float2) * 48)
      .wait();
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(sycl::float2) * 48)
      .wait();
