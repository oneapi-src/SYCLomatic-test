// ===--- c2c_2d_outofplace_make_plan.dp.cpp ------------------*- C++ -*---===//
//
...
bool c2c_2d_outofplace_make_plan() {
  ...
  forward_idata_d = sycl::malloc_device<sycl::float2>(10, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::float2>(10, q_ct1);
  backward_odata_d = sycl::malloc_device<sycl::float2>(10, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::float2) * 10)
      .wait();
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::float2) * 10)
      .wait();
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(sycl::float2) * 10)
      .wait();
