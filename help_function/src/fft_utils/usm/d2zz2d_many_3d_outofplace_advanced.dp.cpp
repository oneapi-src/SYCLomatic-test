...
bool d2zz2d_many_3d_outofplace_advanced() {
  ...
  forward_idata_d = sycl::malloc_device<double>(96, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::double2>(32, q_ct1);
  backward_odata_d = sycl::malloc_device<double>(96, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(double) * 96).wait();
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::double2) * 32)
      .wait();
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(double) * 96).wait();
