...
bool z2z_many_1d_outofplace_advanced() {
  ...
  forward_idata_d = sycl::malloc_device<sycl::double2>(18, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::double2>(6, q_ct1);
  backward_odata_d = sycl::malloc_device<sycl::double2>(18, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::double2) * 18)
      .wait();
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::double2) * 6)
      .wait();
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(sycl::double2) * 18)
      .wait();
