// ===--- z2z_many_3d_outofplace_advanced.dp.cpp --------------*- C++ -*---===//
//
...
bool z2z_many_3d_outofplace_advanced() {
  ...
  sycl::double2 forward_idata_h[48];
  std::memset(forward_idata_h, 0, sizeof(sycl::double2) * 48);
  ...
  forward_idata_d = sycl::malloc_device<sycl::double2>(48, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::double2>(48, q_ct1);
  backward_odata_d = sycl::malloc_device<sycl::double2>(48, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::double2) * 48)
      .wait();
  ...
  plan_fwd->commit(&q_ct1, 3, n, inembed, 1, 24,
                   dpct::library_data_t::complex_double, onembed, 1, 24,
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::double2) * 48)
      .wait();
  ...
  plan_bwd->commit(&q_ct1, 3, n, onembed, 1, 24,
                   dpct::library_data_t::complex_double, inembed, 1, 24,
                   dpct::library_data_t::complex_double, 2, nullptr);
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(sycl::double2) * 48)
      .wait();

  sycl::double2 backward_odata_ref[48] = {
      sycl::double2{0, 24},      sycl::double2{48, 72},
      sycl::double2{96, 120},    sycl::double2{144, 168},
      sycl::double2{192, 216},   sycl::double2{240, 264},
      sycl::double2{288, 312},   sycl::double2{336, 360},
      sycl::double2{384, 408},   sycl::double2{432, 456},
      sycl::double2{480, 504},   sycl::double2{528, 552},
      sycl::double2{576, 600},   sycl::double2{624, 648},
      sycl::double2{672, 696},   sycl::double2{720, 744},
      sycl::double2{768, 792},   sycl::double2{816, 840},
      sycl::double2{864, 888},   sycl::double2{912, 936},
      sycl::double2{960, 984},   sycl::double2{1008, 1032},
      sycl::double2{1056, 1080}, sycl::double2{1104, 1128},
      sycl::double2{0, 24},      sycl::double2{48, 72},
      sycl::double2{96, 120},    sycl::double2{144, 168},
      sycl::double2{192, 216},   sycl::double2{240, 264},
      sycl::double2{288, 312},   sycl::double2{336, 360},
