...
bool z2z_many_1d_inplace_advanced() {
  ...
  sycl::double2 *data_d;
  data_d = sycl::malloc_device<sycl::double2>(18, q_ct1);
  q_ct1.memcpy(data_d, forward_idata_h, sizeof(sycl::double2) * 18).wait();
  ...
  q_ct1.memcpy(forward_odata_h, data_d, sizeof(sycl::double2) * 18).wait();
  ...
  q_ct1.memcpy(backward_odata_h, data_d, sizeof(sycl::double2) * 18).wait();
