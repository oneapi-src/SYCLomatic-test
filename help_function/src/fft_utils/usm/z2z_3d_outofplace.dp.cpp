...
bool z2z_3d_outofplace() {
  ...
  forward_idata_d = sycl::malloc_device<sycl::double2>(30, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::double2>(30, q_ct1);
  backward_odata_d = sycl::malloc_device<sycl::double2>(30, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::double2) * 30)
      .wait();

  plan_fwd = dpct::fft::fft_engine::create(
      &q_ct1, 2, 3, 5, dpct::fft::fft_type::complex_double_to_complex_double);
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::double2) * 30)
      .wait();
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(sycl::double2) * 30)
      .wait();
