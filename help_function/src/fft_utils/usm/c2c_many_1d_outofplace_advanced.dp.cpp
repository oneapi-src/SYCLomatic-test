// ===--- c2c_many_1d_outofplace_advanced.dp.cpp --------------*- C++ -*---===//
//
...
bool c2c_many_1d_outofplace_advanced() {
  ...
  forward_idata_d = sycl::malloc_device<sycl::float2>(18, q_ct1);
  forward_odata_d = sycl::malloc_device<sycl::float2>(6, q_ct1);
  backward_odata_d = sycl::malloc_device<sycl::float2>(18, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::float2) * 18)
      .wait();
  ...
  plan_fwd->commit(&q_ct1, 1, n, inembed, 2, 9,
                   dpct::library_data_t::complex_float, onembed, 1, 3,
  ...
  forward_odata_ref[1] = sycl::float2{-4.73205, -1.26795};
  forward_odata_ref[2] = sycl::float2{-1.26795, -4.73205};
  forward_odata_ref[3] = sycl::float2{6, 9};
  forward_odata_ref[4] = sycl::float2{-4.73205, -1.26795};
  forward_odata_ref[5] = sycl::float2{-1.26795, -4.73205};
  ...
  plan_bwd->commit(&q_ct1, 1, n, onembed, 1, 3,
                   dpct::library_data_t::complex_float, inembed, 2, 9,
                   dpct::library_data_t::complex_float, 2, nullptr);
  ...
  q_ct1.memcpy(backward_odata_h, backward_odata_d, sizeof(sycl::float2) * 18)
      .wait();
