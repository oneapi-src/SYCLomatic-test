// ===--- z2z_1d_outofplace_make_plan.dp.cpp ------------------*- C++ -*---===//
//
...
bool z2z_1d_outofplace_make_plan() {
  ...
  forward_idata_d = (sycl::double2 *)sycl::malloc_device(
      2 * sizeof(sycl::double2) * 7, q_ct1);
  forward_odata_d = (sycl::double2 *)sycl::malloc_device(
      2 * sizeof(sycl::double2) * 7, q_ct1);
  backward_odata_d = (sycl::double2 *)sycl::malloc_device(
      2 * sizeof(sycl::double2) * 7, q_ct1);
  q_ct1.memcpy(forward_idata_d, forward_idata_h, 2 * sizeof(sycl::double2) * 7)
      .wait();
  ...
  q_ct1.memcpy(forward_odata_h, forward_odata_d, 2 * sizeof(sycl::double2) * 7)
      .wait();
  ...
  q_ct1
      .memcpy(backward_odata_h, backward_odata_d, 2 * sizeof(sycl::double2) * 7)
      .wait();
