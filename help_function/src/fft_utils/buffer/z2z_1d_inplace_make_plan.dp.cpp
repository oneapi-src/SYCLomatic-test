// ===--- z2z_1d_inplace_make_plan.dp.cpp ---------------------*- C++ -*---===//
//
...
bool z2z_1d_inplace_make_plan() {
  ...
  sycl::double2 *data_d;
  data_d = (sycl::double2 *)dpct::dpct_malloc(2 * sizeof(sycl::double2) * 7);
  dpct::dpct_memcpy(data_d, forward_idata_h, 2 * sizeof(sycl::double2) * 7,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, data_d, 2 * sizeof(sycl::double2) * 7,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, data_d, 2 * sizeof(sycl::double2) * 7,
                    dpct::device_to_host);
