...
bool z2z_2d_outofplace() {
  ...
  forward_idata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 10);
  forward_odata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 10);
  backward_odata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 10);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h,
                    sizeof(sycl::double2) * 10, dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, forward_odata_d,
                    sizeof(sycl::double2) * 10, dpct::device_to_host);
