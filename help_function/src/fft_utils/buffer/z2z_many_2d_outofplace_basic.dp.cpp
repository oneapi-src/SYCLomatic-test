// ===--- z2z_many_2d_outofplace_basic.dp.cpp -----------------*- C++ -*---===//
//
...
bool z2z_many_2d_outofplace_basic() {
  ...
  forward_idata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 12);
  forward_odata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 12);
  backward_odata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 12);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h,
                    sizeof(sycl::double2) * 12, dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, forward_odata_d,
                    sizeof(sycl::double2) * 12, dpct::device_to_host);
