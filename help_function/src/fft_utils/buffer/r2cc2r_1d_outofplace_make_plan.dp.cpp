// ===--- r2cc2r_1d_outofplace_make_plan.dp.cpp ---------------*- C++ -*---===//
//
...
bool r2cc2r_1d_outofplace_make_plan() {
  ...
  forward_idata_d = (float *)dpct::dpct_malloc(2 * sizeof(float) * 7);
  forward_odata_d =
      (sycl::float2 *)dpct::dpct_malloc(2 * sizeof(sycl::float2) * (7 / 2 + 1));
  backward_odata_d = (float *)dpct::dpct_malloc(2 * sizeof(float) * 7);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h, 2 * sizeof(float) * 7,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(backward_odata_h, backward_odata_d, 2 * sizeof(float) * 7,
                    dpct::device_to_host);
