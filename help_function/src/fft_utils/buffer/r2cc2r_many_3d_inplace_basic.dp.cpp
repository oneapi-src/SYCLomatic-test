...
bool r2cc2r_many_3d_inplace_basic() {
  ...
  float* data_d;
  data_d = (float *)dpct::dpct_malloc(sizeof(float) * 64);
  dpct::dpct_memcpy(data_d, forward_idata_h, sizeof(float) * 64,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, data_d, sizeof(float) * 64,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, data_d, sizeof(float) * 64,
                    dpct::device_to_host);
