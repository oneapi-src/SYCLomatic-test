// ===--- z2z_many_1d_inplace_advanced.dp.cpp -----------------*- C++ -*---===//
//
...
bool z2z_many_1d_inplace_advanced() {
  ...
  forward_idata_h[9] = sycl::double2{0, 1};
  forward_idata_h[11] = sycl::double2{2, 3};
  forward_idata_h[13] = sycl::double2{4, 5};

  sycl::double2 *data_d;
  data_d = (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 18);
  dpct::dpct_memcpy(data_d, forward_idata_h, sizeof(sycl::double2) * 18,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, data_d, sizeof(sycl::double2) * 18,
                    dpct::device_to_host);

  sycl::double2 forward_odata_ref[18];
  forward_odata_ref[0] = sycl::double2{6, 9};
  forward_odata_ref[1] = sycl::double2{2, 3};
  forward_odata_ref[2] = sycl::double2{-4.73205, -1.26795};
  forward_odata_ref[3] = sycl::double2{0, 1};
  forward_odata_ref[4] = sycl::double2{-1.26795, -4.73205};
  forward_odata_ref[5] = sycl::double2{4, 5};
  forward_odata_ref[6] = sycl::double2{0, 0};
  forward_odata_ref[7] = sycl::double2{0, 0};
  forward_odata_ref[8] = sycl::double2{0, 0};
  forward_odata_ref[9] = sycl::double2{6, 9};
  forward_odata_ref[10] = sycl::double2{0, 0};
  forward_odata_ref[11] = sycl::double2{-4.73205, -1.26795};
  forward_odata_ref[12] = sycl::double2{0, 0};
  forward_odata_ref[13] = sycl::double2{-1.26795, -4.73205};
  ...
  dpct::dpct_memcpy(backward_odata_h, data_d, sizeof(sycl::double2) * 18,
                    dpct::device_to_host);
