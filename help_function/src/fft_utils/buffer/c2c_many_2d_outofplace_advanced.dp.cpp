...
bool c2c_many_2d_outofplace_advanced() {
  ...
  forward_idata_d =
      (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 12);
  forward_odata_d =
      (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 12);
  backward_odata_d =
      (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 12);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::float2) * 12,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::float2) * 12,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, backward_odata_d,
                    sizeof(sycl::float2) * 12, dpct::device_to_host);
