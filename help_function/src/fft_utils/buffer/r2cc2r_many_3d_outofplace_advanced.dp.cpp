...
bool r2cc2r_many_3d_outofplace_advanced() {
  ...
  forward_idata_d = (float *)dpct::dpct_malloc(sizeof(float) * 96);
  forward_odata_d =
      (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 32);
  backward_odata_d = (float *)dpct::dpct_malloc(sizeof(float) * 96);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h, sizeof(float) * 96,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::float2) * 32,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, backward_odata_d, sizeof(float) * 96,
                    dpct::device_to_host);
