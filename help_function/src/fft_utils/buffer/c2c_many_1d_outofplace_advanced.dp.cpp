...
bool c2c_many_1d_outofplace_advanced() {
  ...
  forward_idata_d =
      (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 18);
  forward_odata_d = (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 6);
  backward_odata_d =
      (sycl::float2 *)dpct::dpct_malloc(sizeof(sycl::float2) * 18);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h, sizeof(sycl::float2) * 18,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(backward_odata_h, backward_odata_d,
                    sizeof(sycl::float2) * 18, dpct::device_to_host);
