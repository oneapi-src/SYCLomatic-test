// ===--- r2cc2r_2d_inplace_make_plan.dp.cpp ------------------*- C++ -*---===//
//
...
bool r2cc2r_2d_inplace_make_plan() {
  ...
  float* data_d;
  data_d = (float *)dpct::dpct_malloc(sizeof(float) * 24);
  dpct::dpct_memcpy(data_d, forward_idata_h, sizeof(float) * 24,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, data_d, sizeof(float) * 24,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, data_d, sizeof(float) * 24,
                    dpct::device_to_host);
