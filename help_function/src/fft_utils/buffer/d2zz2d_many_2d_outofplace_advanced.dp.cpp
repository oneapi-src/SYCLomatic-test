...
bool d2zz2d_many_2d_outofplace_advanced() {
  ...
  forward_idata_d = (double *)dpct::dpct_malloc(sizeof(double) * 24);
  forward_odata_d =
      (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 8);
  backward_odata_d = (double *)dpct::dpct_malloc(sizeof(double) * 24);
  dpct::dpct_memcpy(forward_idata_d, forward_idata_h, sizeof(double) * 24,
                    dpct::host_to_device);
  ...
  dpct::dpct_memcpy(forward_odata_h, forward_odata_d, sizeof(sycl::double2) * 8,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, backward_odata_d, sizeof(double) * 24,
                    dpct::device_to_host);
