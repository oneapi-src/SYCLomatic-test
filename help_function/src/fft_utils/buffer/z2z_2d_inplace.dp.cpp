...
bool z2z_2d_inplace() {
  ...
  sycl::double2 *data_d;
  data_d = (sycl::double2 *)dpct::dpct_malloc(sizeof(sycl::double2) * 10);
  dpct::dpct_memcpy(data_d, forward_idata_h, sizeof(sycl::double2) * 10,
                    dpct::host_to_device);

  plan_fwd = dpct::fft::fft_engine::create(
      &q_ct1, 2, 5, dpct::fft::fft_type::complex_double_to_complex_double);
  ...
  dpct::dpct_memcpy(forward_odata_h, data_d, sizeof(sycl::double2) * 10,
                    dpct::device_to_host);
  ...
  dpct::dpct_memcpy(backward_odata_h, data_d, sizeof(sycl::double2) * 10,
                    dpct::device_to_host);
