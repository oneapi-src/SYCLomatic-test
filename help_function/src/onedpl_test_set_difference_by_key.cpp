// ====------ onedpl_test_set_difference_by_key.cpp---------- -*- C++ -* ----===////
//
...
class SetDiffByKey {};        // name for policy
class SetDiffByKeyGreater {}; // name for policy
	...
	// Initialize data
        {
            ...
            val_beg2[5] = 9; val_beg2[6] = 9; val_beg2[7] = 9; val_beg2[8] = 0; val_beg2[9] = 9;
        ...
        auto new_policy = oneapi::dpl::execution::make_device_policy<SetDiffByKey>(oneapi::dpl::execution::dpcpp_default);

        // call algorithm
        dpct::set_difference(new_policy, key_beg1_it, key_end1_it, key_beg2_it, key_end2_it,
        ...
        // check values
        {
            ...
            test_name = "set_difference_by_key test 1";

            num_failing += ASSERT_EQUAL(test_name, key_res_beg[0], 1);
            num_failing += ASSERT_EQUAL(test_name, key_res_beg[1], 3);
            num_failing += ASSERT_EQUAL(test_name, key_res_beg[2], 7);
            num_failing += ASSERT_EQUAL(test_name, key_res_beg[3], 9);

            num_failing += ASSERT_EQUAL(test_name, val_res_beg[0], 1);
            ...
            val_beg1[0] = 0; val_beg1[1] = 0; val_beg1[2] = 1; val_beg1[3] = 0; val_beg1[4] = 1;
            val_beg1[5] = 0; val_beg1[6] = 1; val_beg1[7] = 0;
        ...
        // create named policy from existing one.
        auto new_policy2 = oneapi::dpl::execution::make_device_policy<SetDiffByKeyGreater>(oneapi::dpl::execution::dpcpp_default);

        // call algorithm
        dpct::set_difference(new_policy2, key_beg1_it, key_end1_it, key_beg2_it, key_end2_it,
                                    val_beg1_it, val_beg2_it, key_res_beg_it, val_res_beg_it,
	...
	// check values
        {
            ...
            test_name = "set_difference_by_key test 2";
            ...
            num_failing += ASSERT_EQUAL(test_name, key_res_beg[0], 9);
            num_failing += ASSERT_EQUAL(test_name, key_res_beg[1], 7);
