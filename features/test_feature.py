...
exec_tests = ['thrust-vector-2', 'thrust-binary-search', 'thrust-count', 'thrust-copy',
              ...
              'user_defined_rules', 'math-exec', 'math-habs', 'math-emu-half', 'math-emu-half2', 'math-ext-half', 'math-ext-half2', 'cudnn-activation',
              ...
              'thrust_raw_reference_cast', 'thrust_partition_copy', 'thrust_stable_partition_copy', 'sync_warp_p2',
...
def migrate_test():
    ...
    math_extension_tests = ['math-ext-half', 'math-ext-half2']
