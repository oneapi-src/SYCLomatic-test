...
exec_tests = ['asm', 'thrust-vector-2', 'thrust-binary-search', 'thrust-count', 'thrust-copy',
              ...
              'math-emu-bf16', 'math-emu-bf162', 'math-experimental-bf16',
              ...
              'thrust_swap_ranges', 'thrust_uninitialized_fill_n', 'thrust_equal', 'system_atomic']
...
def migrate_test():
    ...
    experimental_bfloat16_tests = ['math-experimental-bf16']
