// ===--- r2cc2r_many_3d_inplace_advanced.cu -----------------*- CUDA -*---===//
//
...
bool r2cc2r_many_3d_inplace_advanced() {
  ...
  cufftMakePlanMany64(plan_fwd, 3, n, inembed, 1, 32, onembed, 1, 16, CUFFT_R2C, 2, &workSize);
  ...
  cufftMakePlanMany64(plan_bwd, 3, n, onembed, 1, 16, inembed, 1, 32, CUFFT_C2R, 2, &workSize);
