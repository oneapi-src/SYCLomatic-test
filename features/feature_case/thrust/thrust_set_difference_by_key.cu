...
void test_1() {
  ...
  thrust::host_vector<int> VBvalue(Bvalue, Bvalue + M);
  ...
  iter_pair result_end = thrust::set_difference_by_key(
      thrust::host, VAkey.begin(), VAkey.end(), VBkey.begin(), VBkey.end(),
      VAvalue.begin(), VBvalue.begin(), VCkey.begin(), VCvalue.begin());
  for (int i = 0; i < P; i++) {
    if (VCkey[i] != anskey[i]) {
...
void test_2() {
  ...
  iter_pair result_end = thrust::set_difference_by_key(
      ...
      VBvalue.begin(), VCkey.begin(), VCvalue.begin());
  for (int i = 0; i < P; i++) {
    if (VCkey[i] != anskey[i]) {
...
void test_3() {
  const int N = 7, M = 5, P = 3;
  int Akey[N] = {9, 6, 5, 4, 3, 1, 0};
  int Avalue[N] = {0, 0, 0, 0, 0, 0, 0};
  int Bkey[M] = {9, 7, 5, 3, 1};
  int Bvalue[N] = {1, 1, 1, 1, 1};
...
void test_4() {
  ...
  iter_pair result_end = thrust::set_difference_by_key(
      VAkey.begin(), VAkey.end(), VBkey.begin(), VBkey.end(), VAvalue.begin(),
      VBvalue.begin(), VCkey.begin(), VCvalue.begin(), thrust::greater<int>());
  for (int i = 0; i < P; i++) {
    if (VCkey[i] != anskey[i]) {
...
void test_5() {
  ...
  thrust::device_vector<int> VBvalue(Bvalue, Bvalue + M);
  ...
  iter_pair result_end = thrust::set_difference_by_key(thrust::device, VAkey.begin(), VAkey.end(), VBkey.begin(), VBkey.end(), VAvalue.begin(), VBvalue.begin(), VCkey.begin(), VCvalue.begin());
  for (int i = 0; i < P; i++) {
    if (VCkey[i] != anskey[i]) {
...
void test_7() {
  ...
  iter_pair result_end = thrust::set_difference_by_key( thrust::device, VAkey.begin(), VAkey.end(), VBkey.begin(), VBkey.end(), VAvalue.begin(), VBvalue.begin(), VCkey.begin(), VCvalue.begin(),thrust::greater<int>());
  for (int i = 0; i < P; i++) {
    if (VCkey[i] != anskey[i]) {
...
void test_9() {
  ...
  thrust::set_difference_by_key(thrust::host, Akey, Akey + N, Bkey, Bkey + M,
                                Avalue, Bvalue, Ckey, Cvalue);
  for (int i = 0; i < P; i++) {
    if (Ckey[i] != anskey[i]) {
...
void test_10() {
  ...
  thrust::set_difference_by_key(Akey, Akey + N, Bkey, Bkey + M, Avalue, Bvalue,
                                Ckey, Cvalue);
  for (int i = 0; i < P; i++) {
    if (Ckey[i] != anskey[i]) {
