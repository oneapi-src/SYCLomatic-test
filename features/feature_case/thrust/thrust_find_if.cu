...
void test_2() {
  ...
  iter = thrust::find_if(device_data.begin(), device_data.end(),  greater_than_four()); 
...
void test_3() {
  ...
  iter = thrust::find_if(host_data.begin(), host_data.end(),  greater_than_four()); 
...
void test_5() {
  ...
  thrust::device_vector<int>::iterator iter;
  iter = thrust::find_if(thrust::device, device_data.begin(), device_data.end(),  greater_than_four()); 
...
void test_6() {
  ...
  thrust::host_vector<int>::iterator iter;
  iter = thrust::find_if(thrust::host, host_data.begin(), host_data.end(),  greater_than_four()); 
