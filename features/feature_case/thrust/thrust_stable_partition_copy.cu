// ====------ thrust_stable_partition_copy.cu------------------- *- CUDA -*
// -----------------===//
//
...
void test_1() {
  ...
  int *evens = result;
  int *odds = result + 5;
  thrust::stable_partition_copy(thrust::host, data, data + N, evens, odds,
                                is_even());
...
void test_2() {
  ...
  thrust::stable_partition_copy(thrust::host, host_data.begin(),
                                host_data.begin() + N, host_evens.begin(),
...
void test_3() {
  ...
  thrust::stable_partition_copy(thrust::device, device_data.begin(),
                                device_data.begin() + N, device_evens.begin(),
...
void test_5() {
  ...
  thrust::stable_partition_copy(host_data.begin(), host_data.begin() + N,
...
void test_6() {
  ...
  thrust::stable_partition_copy(device_data.begin(), device_data.begin() + N,
...
void test_7() {
  ...
  int *evens = result;
  int *odds = result + 5;
  thrust::stable_partition_copy(thrust::host, data, data + N, S, evens, odds,
                                is_even());
  int ref_evens[] = {2, 4, 6, 8, 10};
  int ref_odds[] = {1, 3, 5, 7, 9};
...
void test_8() {
  ...
  thrust::stable_partition_copy(
      thrust::host, host_data.begin(), host_data.begin() + N, host_S.begin(),
      host_evens.begin(), host_odds.begin(), is_even());
  int ref_evens[] = {2, 4, 6, 8, 10};
  int ref_odds[] = {1, 3, 5, 7, 9};
...
void test_9() {
  ...
  thrust::stable_partition_copy(
      thrust::device, device_data.begin(), device_data.begin() + N,
      device_S.begin(), device_evens.begin(), device_odds.begin(), is_even());
  int ref_evens[] = {2, 4, 6, 8, 10};
  int ref_odds[] = {1, 3, 5, 7, 9};
