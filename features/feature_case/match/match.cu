...
__global__ void MatchAllKernel0(unsigned int* data, int *p) {
...
int main() {
  ...
  GridSize = {2};
  BlockSize = {32, 2, 1};
  unsigned int expect01[DATA_NUM] = {
  ...
  MatchAllKernel0<<<GridSize, BlockSize>>>(dev_data_u, dev_data);

  cudaDeviceSynchronize();
  if(!verify_data<unsigned int>(dev_data_u, expect01, DATA_NUM, 2)) {
    std::cout << "MatchAllKernel0" << " verify failed" << std::endl;
    Result = false;
    std::cout << "expect:" << std::endl;
    print_data<unsigned int>(expect01, DATA_NUM);
    std::cout << "current result:" << std::endl;
    print_data<unsigned int>(dev_data_u, DATA_NUM);
  }

  if(!verify_data<int>(dev_data, expect02, DATA_NUM, 2)) {
    std::cout << "MatchAllKernel0" << " verify failed" << std::endl;
    Result = false;
    std::cout << "expect:" << std::endl;
    print_data<int>(expect02, DATA_NUM);
    std::cout << "current result:" << std::endl;
  ...
  unsigned int expect5[DATA_NUM] = {
    286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0,
    286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0,
    286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0,
    286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0, 286331153, 0, 1145324612, 0
  };
